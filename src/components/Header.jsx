  ...
  return (
    ...
    <div className="flex justify-center items-center bg-gray-900 h-[4rem] ">
      <div className="flex justify-center items-center text-gray-300 border-gray-500 border-[1px] ">
        ...
        <input type="text" ref={userRef} placeholder='Search username...' onKeyPress={handleSearch} className="p-1 w-[40rem] bg-gray-950 border-l-[1px] border-gray-500 outline-none font-mono pl-4"/>
      </div>
    </div>
    </>
  )
